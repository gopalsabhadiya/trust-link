...
export function DashboardHeader({
  ...
  return (
    <header className="z-30 flex h-16 shrink-0 items-center gap-3 border-b border-slate-200 bg-white/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-white/80 md:px-6">
      <button
        type="button"
