  ...
  return (
    <div className="flex h-[100dvh] min-h-0 overflow-hidden bg-slate-50">
      <aside className="hidden h-full min-h-0 w-64 shrink-0 flex-col border-r border-slate-200 bg-white md:flex">
        <div className="h-16 shrink-0 animate-pulse border-b border-slate-200 bg-slate-100" />
      ...
      <div className="flex h-full min-h-0 min-w-0 flex-1 flex-col">
        <header className="h-16 shrink-0 animate-pulse border-b border-slate-200 bg-white shadow-sm" />
